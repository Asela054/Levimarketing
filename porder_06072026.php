                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                        <form id="createorderform" autocomplete="off">
                            <div class="form-group mb-1">
                                ...
                                <input type="date" id="orderdate" name="orderdate" class="form-control form-control-sm" value="<?php echo date('Y-m-d') ?>" required>
                            </div>
                            <div class="form-group mb-2">
                                <label class="small font-weight-bold text-dark">Location</label>        
                                 <select name="orderlocation" id="orderlocation" class="form-control form-control-sm" required>       
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select name="supplier" id="supplier" class="form-control form-control-sm selecter2 px-0" required>
                                    <option value="">Select</option>
...
<script>
    $(document).ready(function () {
        ...
        $('#supplier').select2({
            ...
            ajax: {
                url: 'getprocess/getsupplierselect2.php',
                type: 'POST',
                dataType: 'json',
                delay: 250,
        ...
        var orderTable = $('#dataTable').DataTable({
            "destroy": true,
            "processing": true,
            "serverSide": true,
            "deferRender": true,
