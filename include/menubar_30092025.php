...
else if($lastElement=='generatestock.php'){
...
else if($lastElement=='uploadstock.php'){
...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <a class="nav-link p-0 px-3 py-2" href="location.php">
                <div class="nav-link-icon"><i class="fa fa-map-marker"></i></div>
                Location
            </a>
            <?php } if(menucheck($menuprivilegearray, 33)==1){ ?>
            <a class="nav-link p-0 px-3 py-2" href="stocktransfer.php">
                <div class="nav-link-icon"><i class="fas fa-exchange-alt"></i></div>
                Stock Transfer
            </a>

            <?php } if(menucheck($menuprivilegearray, 34)==1 | menucheck($menuprivilegearray, 35)==1){ ?>
            <a class="nav-link p-0 px-3 py-2 collapsed" href="javascript:void(0);" data-toggle="collapse"
            ...
            <div class="collapse <?php if($lastElement=="generatestock.php" | $lastElement=="uploadstock.php"){echo 'show';} ?>"
                id="collapsstock" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                <?php if(menucheck($menuprivilegearray, 34)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1" href="generatestock.php">Generate Stock CSV</a>
                    <?php }if(menucheck($menuprivilegearray, 35)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1" href="uploadstock.php">Upload Stock</a>
                    <?php } ?>
                </nav>
            </div>
            ...
            <?php } if(menucheck($menuprivilegearray, 16)==1 | menucheck($menuprivilegearray, 17)==1 | menucheck($menuprivilegearray, 18)==1 | menucheck($menuprivilegearray, 19)==1 | menucheck($menuprivilegearray, 20)==1 | menucheck($menuprivilegearray, 31)==1){ ?>
            <a class="nav-link p-0 px-3 py-2 collapsed" href="javascript:void(0);" data-toggle="collapse"
            ...
            <div class="collapse <?php if($lastElement=="rptgrn.php" | $lastElement=="rptinvoiceview.php" | $lastElement=="rptinvoicepayment.php" | $lastElement=="rptpaymentreceipt.php" | $lastElement=="rptstock.php" | $lastElement=="rptcredit.php"){echo 'show';} ?>"
                ...
                <?php if(menucheck($menuprivilegearray, 16)==1){ ?>
                    ...
                    <a class="nav-link p-0 px-3 py-1" href="rptcredit.php">Credit Report</a>
                    <?php } ?>
