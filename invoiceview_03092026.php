        ...
        var dataTable = $('#dataTable').DataTable( {
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function(data, type, full) {
                        // Tax invoices show Net Total WITH VAT; non-tax invoices keep the plain nettotal
                        var nettotalValue = (full['invtype'] == 1) ? full['nettotal_with_vat'] : full['nettotal'];
                        if(type === 'display'){
                            return addCommas(parseFloat(nettotalValue).toFixed(2));
                        }
            ...
            "footerCallback": function ( row, data, start, end, display ) {
                ...
                for (var i = 0; i < pageRows.length; i++) {
                    ...
                    // Match the column render: tax invoices sum nettotal_with_vat, non-tax sum nettotal
                    var rowNettotal = (pageRows[i]['invtype'] == 1) ? pageRows[i]['nettotal_with_vat'] : pageRows[i]['nettotal'];
                    nettotalSum  += intVal(rowNettotal);
                }
