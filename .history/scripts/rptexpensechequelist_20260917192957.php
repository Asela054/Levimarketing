 ...
 * `tbl_expences_type_idtbl_expences_type` but the live master table is
...
$joinQuery = "FROM `tbl_expensepayment` AS `u`
    LEFT JOIN `tbl_expences_type` AS `et` ON (`et`.`idtbl_expences_type` = `u`.`tbl_expences_type_idtbl_expences_type`)";
...
if (!empty($_POST['search_expencestype'])) {
    ...
    $extraWhere .= " AND `u`.`tbl_expences_type_idtbl_expences_type` = $expencestypeID";
}
