...
// --- Normalize search term so users can search using the "INV-" /
// "INV" prefix shown on screen, even though manuelinvno is stored
// in the DB as a plain number without that prefix. ---
if (isset($_POST['search']['value']) && $_POST['search']['value'] !== '') {
    $_POST['search']['value'] = preg_replace(
        '/^INV-?/i',
        '',
