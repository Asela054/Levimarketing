...
function initStockTable(catId, catName) {
    stockTables[catId] = $('#stockDetailTable_' + catId).DataTable({
        ...
        ajax: {
            ...
            type: "POST",
            "data": function (d) {
                d.search_category = catId; // fixed to this table's own category
        ...
        buttons: [
            {
                ...
                footer: true,
                messageTop: {
                    text: 'Stock Information Report - ' + catName,
                    fontSize: 15,
                    bold: true,
                    alignment: 'center'
                },
...
$(document).ready(function () {
    ...
    // Build & load every category's table up front
