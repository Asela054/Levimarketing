...
$sqlinvoiceinfo="SELECT `tbl_invoice`.`idtbl_invoice`, `tbl_invoice`.`date`, `tbl_invoice`.`total`, `tbl_invoice`.`discounttotal`, `tbl_invoice`.`nettotal`, `tbl_invoice`.`paymentcomplete`, `tbl_invoice`.`saletype`, `tbl_customer`.`name`, `tbl_customer`.`address` FROM `tbl_invoice` LEFT JOIN `tbl_customer` ON `tbl_customer`.`idtbl_customer`=`tbl_invoice`.`customerid` WHERE `tbl_invoice`.`status`=1 AND `tbl_invoice`.`idtbl_invoice`='$recordID'";
        ...
        <table style="width:100%;">
            <tr>
                <td style="text-align: center; font-size:16px;border-bottom:1px dotted black;" colspan="2">
                    ...
                    <h2 class="font-weight-light" style="margin-top:0;margin-bottom:0;">Levi Marketing Pvt Ltd</h2>
                    No.61/1/G,Jayaweera Mawatha,Gonawala,Kelaniya<br>
                    Tel: 0757000300 / 0701802080 / 0112984823
                </td>
            </tr>
            <tr>
        ...
        <table style="width:100%;border-collapse: collapse;">
            <tr>
                ...
                <td width="45%" style="vertical-align: top;padding:0px;">
                    ...
                    <p style="margin:0px;font-size:13px;font-weight:normal;">Tel: 0757000300 / 0701802080 / 0112984823</p>
                    <p style="margin:0px;font-size:13px;font-weight:normal;"><u>E-Mail: info.levimarketing@gmail.com</u></p>
    ...
    <main>
        <table style="table-layout: fixed;padding:3px;width:100%;border-collapse: collapse;font-size: 13px;">
            ...
            <tfoot>
                ...
                <tr>
                    <td colspan="2"></td>
                    <td colspan="2" style="border-left: 1px solid #000;border-right: 1px solid #000;text-align:left;padding-left:35px;">Credit</td>
