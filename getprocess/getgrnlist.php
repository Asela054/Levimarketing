...
$sql="SELECT 
  ...
  g.total, 
  g.invoicenum, 
  p.tbl_porder_idtbl_porder,
  l.location
FROM tbl_grn AS g
JOIN tbl_porder_grn AS p ON g.idtbl_grn = p.tbl_grn_idtbl_grn
JOIN tbl_location AS l ON g.tbl_location_idtbl_location = l.idtbl_location
WHERE g.status = 1";
