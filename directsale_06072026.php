                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <form id="formqtyadd">
                                    ...
                                    <div class="form-group mb-1">
                                        <label class="small font-weight-bold text-dark">Sale Price (Qty &times; Unit Price)</label>
                                        <input type="tel" name="salepriceedit" id="salepriceedit" class="form-control" readonly tabindex="-1">
                                        <div class="custom-control custom-checkbox mt-1">
                                            <input type="checkbox" class="custom-control-input" id="enablepriceedit">
                                            <label class="custom-control-label small font-weight-bold text-dark" for="enablepriceedit">Edit This Price</label>
                                        </div>
                                    </div>
                                    <div class="form-group mb-1">
                                        <label class="small font-weight-bold text-dark">Discount*</label>
                                        <div class="input-group flex-nowrap">
                                            <input type="number" name="discountpresentage" id="discountpresentage" class="form-control" step=".01" value="0" min="0" required>
                                            <div class="input-group-append">
    ...
    $(document).ready(function () {
        ...
        $('#enablepriceedit').change(function(){
            if($(this).is(':checked')){
                ...
                if(!isNaN(sale) && !isNaN(qty)){
                    $('#salepriceedit').val((sale*qty).toFixed(2));
                }
            }
        });
