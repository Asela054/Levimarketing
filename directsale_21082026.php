    ...
    $(document).ready(function () {
       ...
       // Shared calc so quick-qty buttons and manual typing stay in sync
        ...
        function resetPaymentModalFields(){
            ...
            $('#cardlast4').val('').prop('required', false);   // NEW
            $('#divcardlast4').hide();                          // NEW
        ...
        $('#btnpayaddlist').click(function(){
            if (!$("#paymentform")[0].checkValidity()) {
                ...
                var cardlast4=$('#cardlast4').val();          // NEW
                var paymentmethod = $("#paymentmethod").val();
                var billtype = $('#billtype').val();

                // NEW: basic validation for card payments
                if(paymentmethod==2){
                ...
                var showcard = (paymentmethod==2) ? cardlast4 : '';   // NEW
                ...
                // reset the per-payment fields for the next entry
                $('#amount').val('');
                $('#bank').val('');
                $('#chequeno').val('');
                $('#chequedate').val('');
                ...
                $('#cardlast4').prop('required', false);   // NEW
            }
        });
