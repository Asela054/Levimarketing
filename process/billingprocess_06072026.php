...
foreach($tableData as $row) {
    ...
    `qtycancelstatus`, `qtyreason`, `qty_checked_user`, `qty_updatedatetime`, `updatedatetime`, `tbl_user_idtbl_user`, `customerid`)
    VALUES ('0', '$recorddate', '$total', '$distotal', '$totalWithDis', '$saletype', '0', '0', '0', '0', '0', '$refID', '0', '0', '0', '0', '0', '0', '1', '-', '0', '-', '0', '$recorddate', '$updatedatetime', '$userID', '$customerID')";
