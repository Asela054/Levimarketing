...
if($recordOption==1){
    ...
    $insertsupplier="INSERT INTO `tbl_supplier`(`suppliername`, `contactone`, `contacttwo`, `email`, `address`, `status`, `insertdatetime`,`tbl_user_idtbl_user`) VALUES ('$name','$contact1','$contact2','$email','$address','1', '$updatedatetime', '$userID')";
