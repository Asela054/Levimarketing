...
if($conn->query($insertpayment)==true){
    ...
    foreach($tblData as $rowtabledata){
        ...
        if($invpayamount>0){
            ...
            $updateinvoicehas="INSERT INTO `tbl_invoice_payment_has_tbl_invoice`(`tbl_invoice_payment_idtbl_invoice_payment`, `tbl_invoice_idtbl_invoice`, `total`, `discount`, `payamount`, `fullstatus`, `halfstatus`) VALUES ('$paymentID','$invoiceID','$invpayamount','0','$invpayamount','$fullstatus','$halfstatus')";
